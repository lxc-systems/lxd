...
ZEPHIR_INIT_FUNCS(lxd_endpoint_method_entry) {
	...
	PHP_ME(Lxd_Endpoint, getVersion, NULL, ZEND_ACC_PROTECTED)
	PHP_ME(Lxd_Endpoint, getUrl, NULL, ZEND_ACC_PROTECTED)
	PHP_ME(Lxd_Endpoint, getBase, arginfo_lxd_endpoint_getbase, ZEND_ACC_PROTECTED)
	PHP_ME(Lxd_Endpoint, stripEndpoint, arginfo_lxd_endpoint_stripendpoint, ZEND_ACC_PROTECTED)
	PHP_FE_END
};
