...
ZEPHIR_INIT_FUNCS(lxd_endpoints_containers_method_entry) {
	...
	PHP_ME(Lxd_Endpoints_Containers, getSource, arginfo_lxd_endpoints_containers_getsource, ZEND_ACC_PRIVATE)
	PHP_ME(Lxd_Endpoints_Containers, getOptions, arginfo_lxd_endpoints_containers_getoptions, ZEND_ACC_PRIVATE)
	PHP_ME(Lxd_Endpoints_Containers, getEmptyOptions, arginfo_lxd_endpoints_containers_getemptyoptions, ZEND_ACC_PRIVATE)
	PHP_ME(Lxd_Endpoints_Containers, getRemoteImageOptions, arginfo_lxd_endpoints_containers_getremoteimageoptions, ZEND_ACC_PRIVATE)
