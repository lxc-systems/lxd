...
PHP_METHOD(Lxd_Endpoints_Containers, all) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getbase", NULL, 9);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, &_0, "get", NULL, 0, &_1);
	zephir_check_call_status();
	zephir_array_fetch_string(&_2, &response, SL("type"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 44 TSRMLS_CC);
	if (ZEPHIR_IS_STRING_IDENTICAL(&_2, "error")) {
		RETURN_CCTOR(&response);
	}
	ZEPHIR_OBS_VAR(&_3);
	zephir_array_fetch_string(&_3, &response, SL("metadata"), PH_NOISY, "lxd/endpoints/containers.zep", 48 TSRMLS_CC);
	zephir_get_arrval(&_4, &_3);
	zephir_is_iterable(&_4, 0, "lxd/endpoints/containers.zep", 51);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4), _5)
	{
		ZEPHIR_INIT_NVAR(&item);
		ZVAL_COPY(&item, _5);
		ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "stripendpoint", &_7, 10, &item);
		zephir_check_call_status();
		zephir_array_append(&ret, &_6$$4, PH_SEPARATE, "lxd/endpoints/containers.zep", 49);
...
PHP_METHOD(Lxd_Endpoints_Containers, setState) {
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_4, &response, SL("type"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 92 TSRMLS_CC);
	...
	if (_5) {
		...
		zephir_check_call_status();
		zephir_array_fetch_string(&_9$$3, &response, SL("metadata"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 94 TSRMLS_CC);
		zephir_array_fetch_string(&_10$$3, &_9$$3, SL("id"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 94 TSRMLS_CC);
...
PHP_METHOD(Lxd_Endpoints_Containers, start) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "setstate", NULL, 13, &name, &_0, &_1, &_2, &_3, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Lxd_Endpoints_Containers, getSource) {
	...
	if (zephir_array_isset_string(&options, SL("source"))) {
		...
		zephir_array_fast_append(&only, &_0$$3);
		ZEPHIR_CALL_FUNCTION(&_1$$3, "array_flip", NULL, 14, &only);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&opts, "array_intersect_key", NULL, 15, &options, &_1$$3);
		zephir_check_call_status();
		zephir_array_fetch_string(&_2$$3, &opts, SL("source"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 196 TSRMLS_CC);
		RETURN_CTOR(&_2$$3);
	}
	ZEPHIR_INIT_VAR(&_3);
	...
	zephir_array_fast_append(&_3, &_4);
	zephir_is_iterable(&_3, 0, "lxd/endpoints/containers.zep", 204);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_3), _5)
	{
		...
		if (_6$$4) {
			zephir_array_fetch(&_7$$4, &options, &attr, PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 200 TSRMLS_CC);
			_6$$4 = !(ZEPHIR_IS_EMPTY(&_7$$4));
		}
		if (_6$$4) {
			zephir_create_array(return_value, 1, 0 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(&_8$$5);
			zephir_array_fetch(&_8$$5, &options, &attr, PH_NOISY, "lxd/endpoints/containers.zep", 201 TSRMLS_CC);
...
PHP_METHOD(Lxd_Endpoints_Containers, getOptions) {
	...
	zephir_array_fast_append(&only, &_0);
	ZEPHIR_CALL_FUNCTION(&_1, "array_flip", NULL, 14, &only);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&opts, "array_intersect_key", NULL, 15, &options, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Lxd_Endpoints_Containers, getEmptyOptions) {
	...
	zephir_array_fast_append(&attrs, &_0);
	zephir_is_iterable(&attrs, 0, "lxd/endpoints/containers.zep", 247);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attrs), _1)
	{
		...
		if (_2$$3) {
			zephir_array_fetch(&_3$$3, &options, &attr, PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 242 TSRMLS_CC);
			_2$$3 = !(ZEPHIR_IS_EMPTY(&_3$$3));
		}
		if (_2$$3) {
			ZEPHIR_INIT_LNVAR(_4$$4);
			ZEPHIR_CONCAT_SV(&_4$$4, "empty => true is not compatible with ", &attr);
			zephir_throw_exception_debug(&_4$$4, "lxd/endpoints/containers.zep", 243 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} ZEND_HASH_FOREACH_END();
	ZEPHIR_INIT_NVAR(&attr);
	ZEPHIR_CALL_METHOD(&opts, this_ptr, "getoptions", NULL, 16, &name, &options);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "none");
...
PHP_METHOD(Lxd_Endpoints_Containers, getRemoteImageOptions) {
	...
	if (_1) {
		zephir_array_fetch_string(&_2, &options, SL("protocol"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 265 TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_3);
	...
	if (_1) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "Invalid protocol.  Valid choices: lxd, simplestreams", "lxd/endpoints/containers.zep", 266);
		return;
	}
	ZEPHIR_CALL_METHOD(&_4, &only, "flip", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&remoteOptions, "array_intersect_key", NULL, 15, &options, &_4);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&opts, this_ptr, "getoptions", NULL, 16, &name, &options);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Lxd_Endpoints_Containers, getLocalImageOptions) {
	...
	ZVAL_STRING(&_0, "certificate");
	zephir_array_fast_append(&attrs, &_0);
	zephir_is_iterable(&attrs, 0, "lxd/endpoints/containers.zep", 295);
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attrs), _1)
	{
		ZEPHIR_INIT_NVAR(&attr);
		ZVAL_COPY(&attr, _1);
		_2$$3 = zephir_array_isset(&options, &attr);
		if (_2$$3) {
			zephir_array_fetch(&_3$$3, &options, &attr, PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 290 TSRMLS_CC);
			_2$$3 = !(ZEPHIR_IS_EMPTY(&_3$$3));
		}
		if (_2$$3) {
			ZEPHIR_INIT_LNVAR(_4$$4);
			ZEPHIR_CONCAT_SV(&_4$$4, "Only setting remote server is compatible with ", &attr);
			zephir_throw_exception_debug(&_4$$4, "lxd/endpoints/containers.zep", 291 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
	} ZEND_HASH_FOREACH_END();
...
PHP_METHOD(Lxd_Endpoints_Containers, create) {
	...
	ZEPHIR_CALL_METHOD(&source, this_ptr, "getsource", NULL, 17, &options);
	zephir_check_call_status();
	_0 = zephir_array_isset_string(&options, SL("empty"));
	if (_0) {
		zephir_array_fetch_string(&_1, &options, SL("empty"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 311 TSRMLS_CC);
	...
	if (_2) {
		ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "Source empty", "lxd/endpoints/containers.zep", 312);
		return;
	}
	_3 = zephir_array_isset_string(&options, SL("empty"));
	if (_3) {
		zephir_array_fetch_string(&_4, &options, SL("empty"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 315 TSRMLS_CC);
		_3 = ZEPHIR_IS_EMPTY(&_4);
	}
	_5 = zephir_array_isset_string(&options, SL("empty"));
	if (_5) {
		zephir_array_fetch_string(&_6, &options, SL("empty"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 318 TSRMLS_CC);
		_5 = zephir_is_true(&_6);
	}
	_7 = zephir_array_isset_string(&options, SL("server"));
	if (_7) {
		zephir_array_fetch_string(&_8, &options, SL("server"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 320 TSRMLS_CC);
	...
	if (_3) {
		...
		ZEPHIR_CALL_METHOD(&opts, this_ptr, "getemptyoptions", NULL, 18, &name, &options);
		zephir_check_call_status();
	} else if (_7) {
		ZEPHIR_CALL_METHOD(&opts, this_ptr, "getremoteimageoptions", NULL, 19, &name, &source, &options);
		zephir_check_call_status();
	} else {
		ZEPHIR_CALL_METHOD(&opts, this_ptr, "getlocalimageoptions", NULL, 20, &name, &source, &options);
		zephir_check_call_status();
	}
	zephir_read_property(&_9, this_ptr, SL("curl"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_VAR(&_11);
	ZVAL_STRING(&_11, "containers");
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "getbase", NULL, 9, &_11);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&response, &_9, "post", NULL, 0, &_10, &opts);
	zephir_check_call_status();
	zephir_array_fetch_string(&_12, &response, SL("type"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 328 TSRMLS_CC);
	...
	if (_13) {
		...
		ZEPHIR_CALL_METHOD(&_15$$8, this_ptr, "getbase", NULL, 9, &_16$$8);
		zephir_check_call_status();
		zephir_array_fetch_string(&_17$$8, &response, SL("metadata"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 330 TSRMLS_CC);
		zephir_array_fetch_string(&_18$$8, &_17$$8, SL("id"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 330 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_22$$8, &_21$$8, SL("timeout"), PH_NOISY, "lxd/endpoints/containers.zep", 333 TSRMLS_CC);
...
PHP_METHOD(Lxd_Endpoints_Containers, copy) {
	...
	ZEPHIR_CALL_METHOD(&opts, this_ptr, "getoptions", NULL, 16, &copyName, &options);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "copy");
	zephir_array_update_multi(&opts, &_0 TSRMLS_CC, SL("ss"), 4, SL("source"), SL("type"));
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_3, &response, SL("type"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 353 TSRMLS_CC);
	...
	if (_4) {
		...
		ZEPHIR_CALL_METHOD(&_6$$3, this_ptr, "getbase", NULL, 9, &_7$$3);
		zephir_check_call_status();
		zephir_array_fetch_string(&_8$$3, &response, SL("metadata"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 355 TSRMLS_CC);
		zephir_array_fetch_string(&_9$$3, &_8$$3, SL("id"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 355 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_13$$3, &_12$$3, SL("timeout"), PH_NOISY, "lxd/endpoints/containers.zep", 358 TSRMLS_CC);
...
PHP_METHOD(Lxd_Endpoints_Containers, replace) {
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_4, &response, SL("type"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 374 TSRMLS_CC);
	_5 = !ZEPHIR_IS_STRING_IDENTICAL(&_4, "error");
	if (_5) {
		_5 = wait;
	}
	if (_5) {
		...
		ZEPHIR_CALL_METHOD(&_7$$3, this_ptr, "getbase", NULL, 9, &_8$$3);
		zephir_check_call_status();
		zephir_array_fetch_string(&_9$$3, &response, SL("metadata"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 376 TSRMLS_CC);
		zephir_array_fetch_string(&_10$$3, &_9$$3, SL("id"), PH_NOISY | PH_READONLY, "lxd/endpoints/containers.zep", 376 TSRMLS_CC);
		ZEPHIR_INIT_VAR(&_11$$3);
		ZEPHIR_CONCAT_VSVS(&_11$$3, &_7$$3, "/", &_10$$3, "/wait");
		ZEPHIR_INIT_VAR(&_12$$3);
		zephir_create_array(&_12$$3, 1, 0 TSRMLS_CC);
		...
		zephir_array_fetch_string(&_14$$3, &_13$$3, SL("timeout"), PH_NOISY, "lxd/endpoints/containers.zep", 379 TSRMLS_CC);
...
PHP_METHOD(Lxd_Endpoints_Containers, delete) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "remove", NULL, 21, &fingerprint);
	zephir_check_call_status();
	RETURN_MM();
